...
const waveResults = computed(() => {
    const allResults: RaceResult[] = Object.values(
        props.resultsByCategory || {},
    ).flat() as RaceResult[];
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <!-- Quick Link to Timing Entry & Edit Results -->
                        <Link
                            :href="`/admin/results/entry?event_id=${selectedEvent}`"
                            class="inline-flex items-center gap-1.5 rounded-xl bg-amber-500 px-3.5 py-2 text-xs font-black text-slate-950 shadow-xs transition-all hover:bg-amber-400"
                        >
                ...
                <div v-if="activeTab === 'results'" class="space-y-6">
                    ...
                    >
                        <div
                            class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-slate-50 px-6 py-3 dark:border-slate-800 dark:bg-slate-950"
                        >
                            <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <Link
                                    :href="`/admin/results/entry?event_id=${selectedEvent}&wave=${waveName}`"
                                    class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-bold text-slate-700 shadow-2xs transition-all hover:border-amber-500 hover:text-amber-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-amber-400 dark:hover:text-amber-400"
                                >
                                    <PenLine class="h-3 w-3 text-amber-500" />
                                    <span>Edit Wave Results</span>
                                </Link>
                            </div>
                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td class="px-5 py-3 text-right">
                                            <Link
                                                :href="`/admin/results/entry?event_id=${selectedEvent}&wave=${waveName}`"
                                                class="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-bold text-amber-600 transition-all hover:bg-amber-50 hover:text-amber-700 dark:text-amber-400 dark:hover:bg-slate-800"
                                            >
                        ...
                        <div v-else class="p-8 text-center">
                            ...
                            >
                                No Wave {{ waveName }} results recorded yet for
                                this event.
                            </p>
                            <div class="mt-3">
                                <Link
                                    :href="`/admin/results/entry?event_id=${selectedEvent}&wave=${waveName}`"
                                    class="inline-flex items-center gap-1.5 rounded-xl bg-amber-500 px-4 py-2 text-xs font-black text-slate-950 shadow-sm transition-all hover:bg-amber-400"
                                >
                                    <PenLine class="h-3.5 w-3.5" />
                                    <span>Edit Wave Results</span>
                                </Link>
                    ...
                    >
                        <div
                            class="flex flex-wrap items-center justify-between gap-3 border-b border-amber-500/20 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent px-6 py-3.5 dark:border-amber-500/10"
                        >
                            <div class="flex items-center gap-2.5">
                                ...
                                <div>
                                    <div class="flex items-center gap-2">
                                        <span
                                            class="text-sm font-black text-slate-900 dark:text-white"
                                            >BC Combined Omnium Standings</span
                                        >
                                        <span
                                            class="rounded-full bg-amber-500 px-2 py-0.5 text-[10px] font-black text-slate-950 uppercase"
                                    ...
                                    >
                                        Combined elapsed times & laps from Wave
                                        C (30m) and Wave B (45m) heats.
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                        ...
                        >
                            <table class="w-full text-left text-xs">
                                ...
                                >
                                    <tr>
                                        <th class="px-5 py-3">Combined Pos</th>
                                        <th class="px-5 py-3">Bib #</th>
                                        <th class="px-5 py-3">Racer Name</th>
                                        <th class="px-5 py-3">Team / Club</th>
                                        <th class="px-5 py-3">Wave C (30m)</th>
                                        <th class="px-5 py-3">Wave B (45m)</th>
                                        <th class="px-5 py-3">Total Laps</th>
                                        <th class="px-5 py-3">Combined Time</th>
                                        <th class="px-5 py-3 text-right">
                                            Status
                                        </th>
                                    </tr>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-5 py-3 text-slate-700 dark:text-slate-300"
                                        >
                                            <span
                                                v-if="bc.wave_c_time"
                                        ...
                                        <td
                                            class="px-5 py-3 font-bold text-slate-900 dark:text-slate-100"
                                        >
                                            {{ bc.total_laps }} laps
                                        </td>
                                        <td
                                            class="px-5 py-3 font-mono font-black text-amber-600 dark:text-amber-400"
                                        >
                                            {{ bc.combined_time || '—' }}
                                        </td>
                                        <td class="px-5 py-3 text-right">
                                            ...
                                            <span
                                                v-else
                                                class="inline-flex items-center rounded-full bg-amber-500/10 px-2 py-0.5 text-[10px] font-bold text-amber-600 dark:text-amber-400"
                                            >
                                                In Progress
                                            </span>
                                        </td>
                        ...
                        >
                            No BC racers with recorded results in Wave B or Wave
                            C for this event yet.
                        </div>
                    </div>
                </div>
